<?php
 ...
 if(isset($_POST['sub']))
 {
	...
	$q="SELECT * FROM bloodbank_registration where mobile_no='".$un."' && password='".$ps."'";
	...
	if ($data=mysqli_fetch_assoc($res))
      {
		...
		//echo 'Hello';exit;
		$_SESSION['un']=$un;
		header("Location:frm_d_a_form.php");
...
<tr><td class="lefttd"><b>Bloodbank</td><td><input type="numeric" name="un" placeholder="Mobile.No" required="required"/></td></tr>
